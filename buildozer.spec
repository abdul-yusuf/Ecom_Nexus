...
requirements = python3, kivy==2.1.0, https://github.com/kivymd/KivyMD/archive/master.zip, sdl2_ttf, pillow
...
# android.add_src = %(source.dir)s/libs/target/
